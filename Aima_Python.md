...
When complete, this project will have Python implementations for all the pseudocode algorithms in the book *[Artificial Intelligence: A Modern Approach](http://aima.cs.berkeley.edu).*, as well as tests and examples of use. For each major topic, such as `search`, we provide the following  files:
